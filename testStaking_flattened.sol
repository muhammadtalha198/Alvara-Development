    ...
    AccessControlUpgradeable
{
    ...
    uint public constant REWARD_PERIOD = 10 minutes; 
    ...
    struct rewardData {
     ...
     //["FOREVER","TenMinutes","FifteenMinutes",TwentyMinutes]
    // [2000000,1000000,1000000,6000000]
    // [200000000,150000000,130000000,120000000]
    // [0,12000,18000,24000];  
    // [999999,20,20,20]; 
        ...
        )
    {
        ...
        for (
            ...
            if (_lockData.rewardIdToIncrementedAmount[openingRewardId + 1] > 0)
                incrementedAmount = _lockData.rewardIdToIncrementedAmount[
                    openingRewardId + 1
                ];
        }
