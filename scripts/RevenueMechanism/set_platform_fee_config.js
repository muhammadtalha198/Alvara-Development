...
async function main() {
    ...
    console.log("BSKT Creation Fee:", currentConfig.bsktCreationFee.toString());
    ...
    console.log("BSKT Creation Fee:", updatedConfig.bsktCreationFee.toString());
