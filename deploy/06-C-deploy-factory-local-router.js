...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const ROUTER = "0x959922bE3CAee4b8Cd9a407cc3ac1C251C2007B1"; // Local-Test: BSKT_Pair Router
  const WETH = "0x0B306BF915C4d645ff596e518fAf3F9669b97016"; // Local-Test: BSKT_Pair WETH

  // Get deployed contract addresses
  const alvaAddress = "0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0"; //(await deployments.get("Alvara")).address;
  const bsktBeaconAddress = "0x5FC8d32690cc91D4c39d9d3abcBD16989F875707"; //(await deployments.get("BeaconLayer")).address;
  const bsktPairBeaconAddress = "0x0165878A594ca255338adfa4d48449f69242Eb8F"; //(await deployments.get("BeaconLayer")).address;
  ...
  // Deploy a concrete implementation of the abstract Factory contract
