...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  const bsktBeaconAddress = "0x1E5d8259b0fCAf2ec615369f3F8a8D4cb38a8124"; //(await deployments.get("BeaconLayer")).address;
  const bsktPairBeaconAddress = "0xBcD9461D2e679b9C64C0871665C2ca4Acbf270EF"; //(await deployments.get("BSKTPairBeacon")).address;
